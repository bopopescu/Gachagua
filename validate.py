...
class UserOrderForm(FlaskForm):
    name = StringField('Name', validators=[DataRequired(),Length(min=3, message="Your name is too short")])
    email = StringField('Email', validators=[DataRequired(),Email(message="Invalid Emaill")])
    ...
    product = StringField('product', validators=[DataRequired(), Email(message="Select product")])
    quantity = StringField('quantity', validators=[DataRequired(), Email(message="Input quantity")])
    location = StringField('location', validators=[DataRequired(), Email(message="Enter Location")])
